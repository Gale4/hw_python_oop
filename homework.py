...
class SportsWalking(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        spent_calories = (coeff_calorie_3 * self.weight + (pow(self.get_mean_speed(), 2)
                                                           // self.height) * coeff_calorie_4 * self.weight) * (self.duration * self.MIN_IN_HOUR)
        return spent_calories
...
class Swimming(Training):
    ...
    def get_spent_calories(self) -> float:
        ...
        coeff_spent_1 = 1.1
        coeff_spent_2 = 2
        spent_calories = (self.get_mean_speed() + coeff_spent_1) * \
